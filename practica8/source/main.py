...
if __name__ == '__main__':
    ...
    log_file_path = path.join(
                              path.dirname(path.abspath('log_file_config.conf'
                                                        )
    ...
    try:
        ...
        logger_functions.info(f'Hola, soy {empleado.nombre}'
                              f'{empleado.apellido}.Nací el '
                              f'{empleado.fecha_nacimiento}'
                              f'y mi DNI es {empleado.nro_DNI}'
                              )
