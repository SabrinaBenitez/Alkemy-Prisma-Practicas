...
def read_top10():
    ...
    filehandler = logging.FileHandler('/home/sabrina/airflow/log/log_unidad5.log') 
    ...
    try:
        ...
        to_countries_df.to_excel('/home/sabrina/airflow/log/top10_medals_by_country.xlsx')
